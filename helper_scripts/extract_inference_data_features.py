...
from data.example_dataset.dataset import get_example_dataset_preprocess
...
# get img paths
dataset = get_example_dataset_preprocess(index_file="data/example_dataset/rgb/inference.csv")
...
for path_tuple in path_tuples:
    ...
    if img is None:
        print(f"ERROR: cannot read this img {rgb_path}")
        continue

    if depth is None:
        print(f"ERROR: cannot read this depth map {depth_path}")
        continue
